...
int calcDenseFlowGPU(char *file_name, char *out_file_name, int bound, int type, int step, int dev_id,
...
int main()
{
	...
	calcDenseFlowGPU("F://vsworkspace//dense_flow//dense_flow//test.avi", out_path, 15, 0, 1, 0,0,0);
